...
# --pretrained_init cifar10_vgg16_3_snn_init.pth --constant_lrs
# write a for loop to run v4 - v40
for i in {1..1}
do
    python3 train_snn_converted.py --model vgg16 --dataset cifar10 --t 10 --epochs 50 --version v$i --lr 0.001 --checkpoint 'saved_models/cifar10_vgg16_3.pth' --device cuda:0 
done
